function mofi_video_encode(settings, clean_frames)
%
% Usage: mofi_video_encode(settings [,clean_frames=1])
%
% By Mofi
% Version 1.1, Thu 02 maj 2013 10:37:03 CEST, Added test for which version of FFmpeg is being used.
% Version 1.2, Fri 03 maj 2013 11:27:57 CEST, Frame rate can now be set with two decimals.
% Version 1.3, Wed 08 maj 2013 11:51:59 CEST, Added loglevel switch.
% Version 1.4, Wed 06 Dec 2017 13:13:18 PCT,  Added support for Ubuntu 16.04.
...
if strcmp(FFmpeg_v, 'GIT') 
    scaling = '-q:v 4';
elseif strcmp(FFmpeg_v, '16.04')
    scaling = '-crf 22'; % Sane range= [17-28]. 17 best 28 worst. 
else % STD version
    scaling = '-qscale 4';
end
...
%% Metadata
comment = 'Made with MOFI_video, by Morten F. Rasmussen';
