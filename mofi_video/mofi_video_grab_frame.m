...
% 2014-02-04, MFR, Version 1.4, When figure handle (hf) is not set, handle returned by
%                               'gcf' is used instead.
%
...
if ~isempty(settings.hf)
    ...
    set(gcf,'Position',[1 1 settings.resolution]);
    set(gcf,'Units','pixels');
    drawnow
    saveSameSize(gcf, 'format', 'png', 'file', file, 'dpi',settings.dpi);
end
