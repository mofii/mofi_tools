function img_out = mofi_scanline_cnv_2d (img_in, depth_ar, ang_ar, x_sample_pt, y_sample_pt)

% Scan line convert an image
% img_out = mofi_scanline_cnv_2d (img_in, depth_axis,angle_axis [,x_sample_pt, y_sample_pt])
%
% Input:
