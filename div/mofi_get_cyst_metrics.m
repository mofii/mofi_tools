function st = mofi_get_cyst_metrics(varargin)
%function st = mofi_get_cyst_metrics(options)
%
...
% the speckle. 
%
% The pseudo-GUI (selecting regions using the mouse) does not work on
% figures where 'axis equal' or 'axis image' has been called. This is a bug in the
% 'rubber-band' tool. Scripting works on all figures (axes).
%
% Options:
...
%                               file. Renamed from inspect_cnr to mofi_get_cyst_metrics.
...
% Version 1.18 2014/05/15 MOFI. Updated the help file.
