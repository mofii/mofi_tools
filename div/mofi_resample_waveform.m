function wf_out = mofi_resample_waveform (wf, fs_input, fs_output)
% 
% RESAMPLE_WAVEFORM
% This function resamples a given waveform to a new sampling frequency.
%
% wf_out = mofi_resample_waveform (wf, fs_input, fs_output)
%
% By MOFI, 2013
% 2013-02-22, Init Version
% 2013-09-17, Renamed to mofi_resample_waveform. 
%
