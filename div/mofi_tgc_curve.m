function tgc = mofi_tgc_curve (size_data, dr, f0, loss_cm)
%
% returns a TGC-curve
%
% tgc = mofi_tgc_curve (size_data, dr, f0 [,loss_cm = 0.5 dB/(MHz*cm)])
%
% Input:
...
% Version 1.2, 2013-09-19, Renamed to mofi_tgc_curve. 
%
